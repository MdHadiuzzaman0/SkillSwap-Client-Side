      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {freelancers.slice(0, 3).map((freelancer, index) => {
            ...
            const rankStyles = [
              { border: "border-green-500", bg: "bg-green-500", text: "text-green-600", lightBg: "bg-green-50/60" }, // Rank 1 (Gold)
              ...
              >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    <div className="relative">
                      {freelancer.image ? (
                        <Image
                          ...
                          width={64} height={64} className={`w-16 h-16 rounded-full object-cover border-2 ${rankStyles.border} p-0.5`}
                        />
                      ) : (
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 font-medium mt-1">
                        {freelancer.skills?.slice(0, 2).join(", ") || "Freelancer"} {/* Show skills instead */}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className={`mt-6 ${rankStyles.lightBg} border border-dashed ${rankStyles.border} p-4 rounded-xl flex items-center justify-between`}>
                  ...
                  <div className="flex items-center font-black text-xl text-gray-950">
                    ...
                    <span>{(freelancer.totalEarnings || 0)}</span>
                  </div>
                </div>
